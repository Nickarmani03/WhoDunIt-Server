# Generated by Django 3.2.7 on 2021-09-22 23:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guilty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whodunitapi.guilty')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whodunitapi.movie')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whodunitapi.player')),
                ('movie_night', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whodunitapi.movienight')),
                ('suspect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whodunitapi.suspect')),
            ],
        ),
        migrations.AddField(
